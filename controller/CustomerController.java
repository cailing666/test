...
public class CustomerController {
    ...
    public String listCustomer(@RequestParam(defaultValue = "1",value = "pageNum",required = false) Integer pageNum,
                               @RequestParam(defaultValue = "10",value = "pageSize",required = false) Integer pageSize, Model model, Customer customer){
    ...
    public String preSaveBook(){
        return "customer-preSaveCustomer";
    }
    ...
    public String preUpdateBook(@PathVariable("id")Integer id,Model model){
        ...
        return "customer-preUpdateCustomer-id";
    }
